#!/usr/bin/env python3
"""Plot dynamic-link refinement scan."""
...
DATA_PATH = ROOT / 'papers' / 'paper-08' / 'data' / 'multiring_link_dynamics_scan_summary.json'
...
def main() -> None:
    ...
    axes[0].set_title('Dynamic-link metrics vs baseline')
    ...
    axes[1].set_title('Dynamic-link heatmap')
    fig.colorbar(im, ax=axes[1])
    fig.tight_layout()
    _save(fig, 'multiring_link_dynamics_summary.png')
