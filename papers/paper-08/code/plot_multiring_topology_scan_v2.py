#!/usr/bin/env python3
"""Plot targeted V2 topology scan."""
...
DATA_PATH = ROOT / 'papers' / 'paper-08' / 'data' / 'multiring_topology_scan_v2_summary.json'
...
def main() -> None:
    ...
    axes[0].set_title('V2 topology metrics vs baseline')
    ...
    axes[1].set_title('V2 topology heatmap')
    fig.colorbar(im, ax=axes[1])
    fig.tight_layout()
    _save(fig, 'multiring_topology_v2_summary.png')
